...
public class CpuPlayer extends Player {
  ...
  public CpuPlayer(int row, int col, Board board, int vel) {
    super(row, col, board);
    ...
    int proximo = (numCols + numRows) / 2;

//    for (int i = 0; i < HumanPlayer.setTimer(); i++){
//      if (Element.getRow() < HumanPlayer.getRow() + proximo && Element.getCol() < HumanPlayer.getCol() + proximo){
//        vel = 2;
//      } else {
//        vel = 1;
//      }
